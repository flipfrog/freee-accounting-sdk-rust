...
pub struct DealResponseDeal {
    ...
    pub renews: Option<Vec<crate::models::DealResponseDealRenews>>,
    /// 取引の支払行
    ...
    pub receipts: Option<Vec<crate::models::DealResponseDealReceipts>>,
}

impl DealResponseDeal {
    pub fn new(id: i32, company_id: i32, issue_date: String, amount: i64, partner_id: i32, status: Status) -> DealResponseDeal {
        DealResponseDeal {
            id,
            company_id,
            issue_date,
