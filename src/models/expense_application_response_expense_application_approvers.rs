...
impl ExpenseApplicationResponseExpenseApplicationApprovers {
    pub fn new(step_id: i32, user_id: Option<i32>, status: Status, is_force_action: bool, resource_type: ResourceType) -> ExpenseApplicationResponseExpenseApplicationApprovers {
