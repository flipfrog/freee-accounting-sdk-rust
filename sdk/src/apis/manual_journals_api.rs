...
pub async fn get_manual_journals(configuration: &configuration::Configuration, company_id: i32, start_issue_date: Option<&str>, end_issue_date: Option<&str>, entry_side: Option<&str>, account_item_id: Option<i32>, min_amount: Option<i64>, max_amount: Option<i64>, partner_id: Option<i32>, partner_code: Option<&str>, item_id: Option<i32>, section_id: Option<i32>, segment_1_tag_id: Option<i64>, segment_2_tag_id: Option<i64>, segment_3_tag_id: Option<i64>, comment_status: Option<&str>, comment_important: Option<bool>, adjustment: Option<&str>, txn_number: Option<&str>, offset: Option<i64>, limit: Option<i32>) -> Result<crate::models::InlineResponse2004, Error<GetManualJournalsError>> {
    let local_var_configuration = configuration;
