...
pub async fn get_companies(configuration: &configuration::Configuration, ) -> Result<crate::models::CompanyIndexResponse, Error<GetCompaniesError>> {
    ...
    let local_var_uri_str = format!("{}/api/1/companies", local_var_configuration.base_path);
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<GetCompaniesError> = serde_json::from_str(&local_var_content).ok();
...
pub async fn get_company(configuration: &configuration::Configuration, id: i32, details: Option<bool>, account_items: Option<bool>, taxes: Option<bool>, items: Option<bool>, partners: Option<bool>, sections: Option<bool>, tags: Option<bool>, walletables: Option<bool>) -> Result<crate::models::CompanyResponse, Error<GetCompanyError>> {
    ...
    let local_var_uri_str = format!("{}/api/1/companies/{id}", local_var_configuration.base_path, id=id);
    let mut local_var_req_builder = local_var_client.request(reqwest::Method::GET, local_var_uri_str.as_str());

    if let Some(ref local_var_str) = details {
        local_var_req_builder = local_var_req_builder.query(&[("details", &local_var_str.to_string())]);
    }
    if let Some(ref local_var_str) = account_items {
        local_var_req_builder = local_var_req_builder.query(&[("account_items", &local_var_str.to_string())]);
    }
    if let Some(ref local_var_str) = taxes {
        local_var_req_builder = local_var_req_builder.query(&[("taxes", &local_var_str.to_string())]);
    }
    if let Some(ref local_var_str) = items {
        local_var_req_builder = local_var_req_builder.query(&[("items", &local_var_str.to_string())]);
    }
    if let Some(ref local_var_str) = partners {
        local_var_req_builder = local_var_req_builder.query(&[("partners", &local_var_str.to_string())]);
    }
    if let Some(ref local_var_str) = sections {
        local_var_req_builder = local_var_req_builder.query(&[("sections", &local_var_str.to_string())]);
    }
    if let Some(ref local_var_str) = tags {
        local_var_req_builder = local_var_req_builder.query(&[("tags", &local_var_str.to_string())]);
    }
    if let Some(ref local_var_str) = walletables {
        local_var_req_builder = local_var_req_builder.query(&[("walletables", &local_var_str.to_string())]);
    }
    if let Some(ref local_var_user_agent) = local_var_configuration.user_agent {
        local_var_req_builder = local_var_req_builder.header(reqwest::header::USER_AGENT, local_var_user_agent.clone());
    }
