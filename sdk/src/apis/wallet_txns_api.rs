...
pub async fn get_wallet_txns(configuration: &configuration::Configuration, company_id: i32, walletable_type: Option<&str>, walletable_id: Option<i32>, start_date: Option<&str>, end_date: Option<&str>, entry_side: Option<&str>, offset: Option<i64>, limit: Option<i32>) -> Result<crate::models::InlineResponse20014, Error<GetWalletTxnsError>> {
    let local_var_configuration = configuration;
