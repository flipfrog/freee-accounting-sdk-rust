...
pub async fn download_receipt(configuration: &configuration::Configuration, id: i32, company_id: i32) -> Result<std::path::PathBuf, Error<DownloadReceiptError>> {
    let local_var_configuration = configuration;
...
pub async fn get_receipts(configuration: &configuration::Configuration, company_id: i32, start_date: &str, end_date: &str, user_name: Option<&str>, number: Option<i32>, comment_type: Option<&str>, comment_important: Option<bool>, category: Option<&str>, offset: Option<i64>, limit: Option<i32>) -> Result<crate::models::InlineResponse2005, Error<GetReceiptsError>> {
    let local_var_configuration = configuration;
