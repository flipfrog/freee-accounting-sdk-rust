...
pub async fn get_walletable(configuration: &configuration::Configuration, id: i32, _type: &str, company_id: i32) -> Result<crate::models::InlineResponse20016, Error<GetWalletableError>> {
    let local_var_configuration = configuration;
...
pub async fn get_walletables(configuration: &configuration::Configuration, company_id: i32, with_balance: Option<bool>, _type: Option<&str>) -> Result<crate::models::InlineResponse20015, Error<GetWalletablesError>> {
    let local_var_configuration = configuration;
...
pub async fn update_walletable(configuration: &configuration::Configuration, id: i32, _type: &str, walletable_update_params: Option<crate::models::WalletableUpdateParams>) -> Result<crate::models::InlineResponse20016, Error<UpdateWalletableError>> {
    let local_var_configuration = configuration;
