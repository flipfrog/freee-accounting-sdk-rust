...
/// struct for typed errors of method [`destroy_transfer`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum DestroyTransferError {
    Status400(crate::models::BadRequestError),
    Status401(crate::models::UnauthorizedError),
    Status403(crate::models::ForbiddenError),
...
/// struct for typed errors of method [`get_transfers`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum GetTransfersError {
    Status400(crate::models::BadRequestError),
    Status401(crate::models::UnauthorizedError),
    Status403(crate::models::ForbiddenError),
    Status500(crate::models::InternalServerError),
...
pub async fn create_transfer(configuration: &configuration::Configuration, transfer_params: Option<crate::models::TransferParams>) -> Result<crate::models::TransferResponse, Error<CreateTransferError>> {
    let local_var_configuration = configuration;

    let local_var_client = &local_var_configuration.client;

    let local_var_uri_str = format!("{}/api/1/transfers", local_var_configuration.base_path);
    ...
    local_var_req_builder = local_var_req_builder.json(&transfer_params);
...
pub async fn destroy_transfer(configuration: &configuration::Configuration, id: i32, company_id: i32) -> Result<(), Error<DestroyTransferError>> {
    let local_var_configuration = configuration;

    let local_var_client = &local_var_configuration.client;

    let local_var_uri_str = format!("{}/api/1/transfers/{id}", local_var_configuration.base_path, id=id);
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<DestroyTransferError> = serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
        Err(Error::ResponseError(local_var_error))
    }
}
...
pub async fn get_transfer(configuration: &configuration::Configuration, id: i32, company_id: i32) -> Result<crate::models::TransferResponse, Error<GetTransferError>> {
    let local_var_configuration = configuration;
...
pub async fn get_transfers(configuration: &configuration::Configuration, company_id: i32, start_date: Option<&str>, end_date: Option<&str>, offset: Option<i64>, limit: Option<i32>) -> Result<crate::models::InlineResponse20011, Error<GetTransfersError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<GetTransfersError> = serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
        Err(Error::ResponseError(local_var_error))
    }
}
...
pub async fn update_transfer(configuration: &configuration::Configuration, id: i32, transfer_params: crate::models::TransferParams) -> Result<crate::models::TransferResponse, Error<UpdateTransferError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<UpdateTransferError> = serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
        Err(Error::ResponseError(local_var_error))
    }
}
