...
pub struct TrialPlSectionsResponseTrialPlSectionsBalances {
    /// 勘定科目カテゴリー名
    ...
    pub sections: Option<Vec<crate::models::TrialPlSectionsResponseTrialPlSectionsSections>>,
    /// 合計行(勘定科目カテゴリーの時のみ含まれる)
    #[serde(rename = "total_line", skip_serializing_if = "Option::is_none")]
    pub total_line: Option<bool>,
}

impl TrialPlSectionsResponseTrialPlSectionsBalances {
    pub fn new() -> TrialPlSectionsResponseTrialPlSectionsBalances {
