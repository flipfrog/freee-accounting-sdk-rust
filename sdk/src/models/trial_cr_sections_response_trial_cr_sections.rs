...
impl TrialCrSectionsResponseTrialCrSections {
    pub fn new(company_id: i32, section_ids: String, balances: Vec<crate::models::TrialCrSectionsResponseTrialCrSectionsBalances>) -> TrialCrSectionsResponseTrialCrSections {
