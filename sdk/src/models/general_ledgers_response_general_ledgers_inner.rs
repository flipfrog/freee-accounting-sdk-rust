...
pub struct GeneralLedgersResponseGeneralLedgersInner {
    /// 勘定科目ID
...
impl GeneralLedgersResponseGeneralLedgersInner {
    pub fn new() -> GeneralLedgersResponseGeneralLedgersInner {
        GeneralLedgersResponseGeneralLedgersInner {
