...
pub struct TrialBsTwoYearsResponseTrialBsTwoYearsSections {
    /// 期末残高
...
impl TrialBsTwoYearsResponseTrialBsTwoYearsSections {
    pub fn new(id: i32) -> TrialBsTwoYearsResponseTrialBsTwoYearsSections {
