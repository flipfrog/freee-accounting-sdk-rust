...
impl AccountItemCreateParamsAccountItem {
    pub fn new(name: String, tax_code: i32, group_name: String, account_category_id: i32, corresponding_income_id: i32, corresponding_expense_id: i32) -> AccountItemCreateParamsAccountItem {
