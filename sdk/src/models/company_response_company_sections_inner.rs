...
pub struct CompanyResponseCompanySectionsInner {
    /// 部門ID
    #[serde(rename = "id")]
    pub id: i32,
    /// 部門名 (30文字以内)
...
impl CompanyResponseCompanySectionsInner {
    pub fn new(id: i32, name: String) -> CompanyResponseCompanySectionsInner {
        CompanyResponseCompanySectionsInner {
            id,
            name,
            shortcut1: None,
            shortcut2: None,
