...
pub struct TrialBsResponseTrialBsBalancesInner {
    /// 勘定科目ID(勘定科目の時のみ含まれる)
    ...
    pub partners: Option<Vec<crate::models::TrialBsResponseTrialBsBalancesInnerPartnersInner>>,
    /// breakdown_display_type:item, account_item_display_type:account_item指定時のみ含まれる
    #[serde(rename = "items", skip_serializing_if = "Option::is_none")]
    pub items: Option<Vec<crate::models::TrialBsResponseTrialBsBalancesInnerItemsInner>>,
    ...
    pub sections: Option<Vec<crate::models::TrialBsResponseTrialBsBalancesInnerSectionsInner>>,
    ...
    pub segment_1_tags: Option<Vec<crate::models::TrialBsResponseTrialBsBalancesInnerSegment1TagsInner>>,
    ...
    pub segment_2_tags: Option<Vec<crate::models::TrialBsResponseTrialBsBalancesInnerSegment2TagsInner>>,
    ...
    pub segment_3_tags: Option<Vec<crate::models::TrialBsResponseTrialBsBalancesInnerSegment3TagsInner>>,
    /// 勘定科目カテゴリー名
...
impl TrialBsResponseTrialBsBalancesInner {
    pub fn new() -> TrialBsResponseTrialBsBalancesInner {
