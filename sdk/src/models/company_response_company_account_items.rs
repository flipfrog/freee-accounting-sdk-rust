...
pub struct CompanyResponseCompanyAccountItems {
    /// 勘定科目ID
    #[serde(rename = "id")]
    pub id: i32,
    /// 勘定科目名 (30文字以内)
...
impl CompanyResponseCompanyAccountItems {
    pub fn new(id: i32, name: String, categories: Vec<String>) -> CompanyResponseCompanyAccountItems {
