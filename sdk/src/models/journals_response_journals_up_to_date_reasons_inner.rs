...
pub struct JournalsResponseJournalsUpToDateReasonsInner {
    /// コード
    #[serde(rename = "code")]
    pub code: Code,
    /// 集計が最新でない理由
...
impl JournalsResponseJournalsUpToDateReasonsInner {
    pub fn new(code: Code, message: String) -> JournalsResponseJournalsUpToDateReasonsInner {
        JournalsResponseJournalsUpToDateReasonsInner {
            code,
            message,
        }
    }
...
pub enum Code {
    #[serde(rename = "depreciation_creating")]
    Creating,
