...
pub struct ManualJournalDetailsInner {
    /// 貸借行ID
    #[serde(rename = "id")]
    pub id: i64,
...
impl ManualJournalDetailsInner {
    pub fn new(id: i64, entry_side: EntrySide, account_item_id: i32, tax_code: i32, partner_id: Option<i32>, partner_name: Option<String>, partner_long_name: Option<String>, item_id: Option<i32>, item_name: Option<String>, section_id: Option<i32>, section_name: Option<String>, tag_ids: Vec<i32>, tag_names: Vec<String>, amount: i32, vat: i32, description: String) -> ManualJournalDetailsInner {
