...
pub struct AccountItemResponseAccountItemItemsInner {
    /// 品目ID
    #[serde(rename = "id")]
    pub id: i32,
    /// 品目
...
impl AccountItemResponseAccountItemItemsInner {
    pub fn new(id: i32, name: String) -> AccountItemResponseAccountItemItemsInner {
        AccountItemResponseAccountItemItemsInner {
            id,
            name,
        }
    }
