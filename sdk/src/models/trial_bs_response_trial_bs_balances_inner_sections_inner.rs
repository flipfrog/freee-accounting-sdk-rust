...
pub struct TrialBsResponseTrialBsBalancesInnerSectionsInner {
    /// 部門ID
    #[serde(rename = "id")]
    pub id: i32,
    /// 部門名
...
impl TrialBsResponseTrialBsBalancesInnerSectionsInner {
    pub fn new(id: i32) -> TrialBsResponseTrialBsBalancesInnerSectionsInner {
        TrialBsResponseTrialBsBalancesInnerSectionsInner {
            id,
            name: None,
