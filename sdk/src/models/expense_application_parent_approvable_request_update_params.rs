...
pub struct ExpenseApplicationParentApprovableRequestUpdateParams {
    /// 事業所ID
    #[serde(rename = "company_id")]
    pub company_id: i32,
    /// 各種申請ID - 経費申請に関連付ける各種申請IDを指定します - 閲覧権限のある承認済みの既存各種申請IDのみ指定ができます - 既に経費申請に紐付いている各種申請との関連は解除されます - 経費申請に紐付く各種申請を解除する場合はnullを指定してください 
    #[serde(rename = "parent_id", deserialize_with = "Option::deserialize")]
    pub parent_id: Option<i32>,
}

impl ExpenseApplicationParentApprovableRequestUpdateParams {
    pub fn new(company_id: i32, parent_id: Option<i32>) -> ExpenseApplicationParentApprovableRequestUpdateParams {
