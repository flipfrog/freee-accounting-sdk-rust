...
pub struct TrialPlSegment1TagsResponseTrialPlSegment1TagsBalancesInner {
    /// 勘定科目ID(勘定科目の時のみ含まれる)
    ...
    pub segment_1_tags: Option<Vec<crate::models::TrialPlSegment1TagsResponseTrialPlSegment1TagsBalancesInnerSegment1TagsInner>>,
    /// 勘定科目カテゴリー名
...
impl TrialPlSegment1TagsResponseTrialPlSegment1TagsBalancesInner {
    pub fn new() -> TrialPlSegment1TagsResponseTrialPlSegment1TagsBalancesInner {
        TrialPlSegment1TagsResponseTrialPlSegment1TagsBalancesInner {
