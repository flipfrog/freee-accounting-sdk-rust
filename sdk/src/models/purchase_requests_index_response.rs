...
pub struct PurchaseRequestsIndexResponse {
    #[serde(rename = "purchase_requests")]
    pub purchase_requests: Vec<crate::models::PurchaseRequestsIndexResponsePurchaseRequestsInner>,
}

impl PurchaseRequestsIndexResponse {
    pub fn new(purchase_requests: Vec<crate::models::PurchaseRequestsIndexResponsePurchaseRequestsInner>) -> PurchaseRequestsIndexResponse {
