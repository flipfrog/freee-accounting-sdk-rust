...
pub struct QuotationIndexResponseQuotations {
    /// 市区町村・番地
...
impl QuotationIndexResponseQuotations {
    pub fn new(company_id: i32, company_name: String, id: i32, issue_date: String, partner_id: Option<i32>, partner_title: Option<String>, quotation_layout: QuotationLayout, quotation_number: String, quotation_status: QuotationStatus, tax_entry_method: TaxEntryMethod, total_amount: i32, total_amount_per_vat_rate: crate::models::InvoiceIndexResponseTotalAmountPerVatRate) -> QuotationIndexResponseQuotations {
