...
pub struct QuotationIndexResponseQuotationsInner {
    /// 見積書ID
    #[serde(rename = "id")]
    pub id: i32,
    /// 事業所ID
...
impl QuotationIndexResponseQuotationsInner {
    pub fn new(id: i32, company_id: i32, issue_date: String, partner_id: Option<i32>, quotation_number: String, total_amount: i32, quotation_status: QuotationStatus, partner_title: Option<String>, company_name: String, quotation_layout: QuotationLayout, tax_entry_method: TaxEntryMethod, total_amount_per_vat_rate: crate::models::InvoiceIndexResponseInvoicesInnerTotalAmountPerVatRate) -> QuotationIndexResponseQuotationsInner {
