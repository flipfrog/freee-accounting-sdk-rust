...
pub struct TrialCrResponseTrialCr {
    ...
    pub balances: Vec<crate::models::TrialCrResponseTrialCrBalances>,
...
impl TrialCrResponseTrialCr {
    pub fn new(balances: Vec<crate::models::TrialCrResponseTrialCrBalances>, company_id: i32) -> TrialCrResponseTrialCr {
