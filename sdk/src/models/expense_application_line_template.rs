...
pub struct ExpenseApplicationLineTemplate {
    /// 経費科目ID
    #[serde(rename = "id")]
    pub id: i32,
    /// 経費科目名
...
impl ExpenseApplicationLineTemplate {
    pub fn new(id: i32, name: String, account_item_name: String, tax_name: String) -> ExpenseApplicationLineTemplate {
