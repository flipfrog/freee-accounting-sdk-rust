...
pub struct TrialPlSegment1TagsResponse {
    #[serde(rename = "trial_pl_segment_1_tags")]
    pub trial_pl_segment_1_tags: Box<crate::models::TrialPlSegment1TagsResponseTrialPlSegment1Tags>,
    /// 集計結果が最新かどうか
...
impl TrialPlSegment1TagsResponse {
    pub fn new(trial_pl_segment_1_tags: crate::models::TrialPlSegment1TagsResponseTrialPlSegment1Tags, up_to_date: bool) -> TrialPlSegment1TagsResponse {
        TrialPlSegment1TagsResponse {
            trial_pl_segment_1_tags: Box::new(trial_pl_segment_1_tags),
            up_to_date,
