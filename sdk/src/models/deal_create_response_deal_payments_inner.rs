...
pub struct DealCreateResponseDealPaymentsInner {
    /// 取引行ID
    #[serde(rename = "id")]
    pub id: i64,
    /// 支払日
...
impl DealCreateResponseDealPaymentsInner {
    pub fn new(id: i64, date: String, amount: i64) -> DealCreateResponseDealPaymentsInner {
        DealCreateResponseDealPaymentsInner {
            id,
            date,
