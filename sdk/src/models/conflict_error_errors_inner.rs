...
pub struct ConflictErrorErrorsInner {
...
impl ConflictErrorErrorsInner {
    pub fn new(messages: Vec<String>, r#type: RHashType) -> ConflictErrorErrorsInner {
        ConflictErrorErrorsInner {
            messages,
            r#type,
        }
    }
