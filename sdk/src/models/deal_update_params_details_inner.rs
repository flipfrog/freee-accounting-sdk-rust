...
pub struct DealUpdateParamsDetailsInner {
...
impl DealUpdateParamsDetailsInner {
    pub fn new(tax_code: i32, account_item_id: i32, amount: i64) -> DealUpdateParamsDetailsInner {
