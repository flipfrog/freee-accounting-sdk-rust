...
pub struct ApprovalRequestResponseApprovalRequestApprovers {
    /// 代理承認済みかどうか
...
impl ApprovalRequestResponseApprovalRequestApprovers {
    pub fn new(is_force_action: bool, resource_type: ResourceType, status: Status, step_id: i32, user_id: Option<i32>) -> ApprovalRequestResponseApprovalRequestApprovers {
