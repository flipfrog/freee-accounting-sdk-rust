...
pub struct CompanyResponseCompanyPartners {
    /// 取引先ID
    #[serde(rename = "id")]
    pub id: i32,
    /// 取引先コード
...
impl CompanyResponseCompanyPartners {
    pub fn new(id: i32, code: Option<String>, name: String) -> CompanyResponseCompanyPartners {
