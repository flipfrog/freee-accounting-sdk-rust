...
pub struct TrialPlSegment1TagsResponseTrialPlSegment1TagsBalancesInnerSegment1TagsInnerSectionsInner {
    /// 部門ID
    #[serde(rename = "id")]
    pub id: i32,
    /// 部門名
...
impl TrialPlSegment1TagsResponseTrialPlSegment1TagsBalancesInnerSegment1TagsInnerSectionsInner {
    pub fn new(id: i32) -> TrialPlSegment1TagsResponseTrialPlSegment1TagsBalancesInnerSegment1TagsInnerSectionsInner {
        TrialPlSegment1TagsResponseTrialPlSegment1TagsBalancesInnerSegment1TagsInnerSectionsInner {
            id,
            name: None,
