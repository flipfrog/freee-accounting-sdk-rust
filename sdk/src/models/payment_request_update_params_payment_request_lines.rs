...
pub struct PaymentRequestUpdateParamsPaymentRequestLines {
...
impl PaymentRequestUpdateParamsPaymentRequestLines {
    pub fn new(amount: i32) -> PaymentRequestUpdateParamsPaymentRequestLines {
