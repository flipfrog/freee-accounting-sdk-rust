...
pub struct TrialPlSegment1TagsResponseTrialPlSegment1TagsBalancesInnerSegment1TagsInner {
    /// セグメント1タグID
    #[serde(rename = "id")]
    pub id: i32,
    /// セグメント1タグ名
...
impl TrialPlSegment1TagsResponseTrialPlSegment1TagsBalancesInnerSegment1TagsInner {
    pub fn new(id: i32) -> TrialPlSegment1TagsResponseTrialPlSegment1TagsBalancesInnerSegment1TagsInner {
        TrialPlSegment1TagsResponseTrialPlSegment1TagsBalancesInnerSegment1TagsInner {
            id,
            name: None,
