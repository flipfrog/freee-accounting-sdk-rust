...
pub struct TrialPlSegment3TagsResponseTrialPlSegment3Tags {
    /// 事業所ID
    #[serde(rename = "company_id")]
    pub company_id: i32,
    /// 出力するセグメント3の指定
    #[serde(rename = "segment_3_tag_ids")]
    pub segment_3_tag_ids: String,
    ...
    pub balances: Vec<crate::models::TrialPlSegment3TagsResponseTrialPlSegment3TagsBalancesInner>,
}

impl TrialPlSegment3TagsResponseTrialPlSegment3Tags {
    pub fn new(company_id: i32, segment_3_tag_ids: String, balances: Vec<crate::models::TrialPlSegment3TagsResponseTrialPlSegment3TagsBalancesInner>) -> TrialPlSegment3TagsResponseTrialPlSegment3Tags {
