...
pub struct ExpenseApplicationResponseExpenseApplicationExpenseApplicationLinesInner {
    /// 経費申請の項目行ID
    #[serde(rename = "id")]
    pub id: i64,
    /// 日付 (yyyy-mm-dd)
...
impl ExpenseApplicationResponseExpenseApplicationExpenseApplicationLinesInner {
    pub fn new(id: i64) -> ExpenseApplicationResponseExpenseApplicationExpenseApplicationLinesInner {
