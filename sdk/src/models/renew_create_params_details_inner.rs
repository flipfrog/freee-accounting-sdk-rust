...
pub struct RenewCreateParamsDetailsInner {
    /// 勘定科目ID
...
impl RenewCreateParamsDetailsInner {
    pub fn new(account_item_id: i32, tax_code: i32, amount: i64) -> RenewCreateParamsDetailsInner {
