...
pub struct TrialBsTwoYearsResponseTrialBsTwoYearsItems {
    /// 期末残高
...
impl TrialBsTwoYearsResponseTrialBsTwoYearsItems {
    pub fn new(id: i32) -> TrialBsTwoYearsResponseTrialBsTwoYearsItems {
