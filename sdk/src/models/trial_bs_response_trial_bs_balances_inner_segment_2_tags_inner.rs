...
pub struct TrialBsResponseTrialBsBalancesInnerSegment2TagsInner {
    /// セグメント2タグID
    #[serde(rename = "id")]
    pub id: i32,
    /// セグメント2タグ名
...
impl TrialBsResponseTrialBsBalancesInnerSegment2TagsInner {
    pub fn new(id: i32) -> TrialBsResponseTrialBsBalancesInnerSegment2TagsInner {
        TrialBsResponseTrialBsBalancesInnerSegment2TagsInner {
            id,
            name: None,
