...
pub struct TrialPlSegment3TagsResponseTrialPlSegment3TagsBalances {
    /// 勘定科目カテゴリー名
    ...
    pub segment_3_tags: Option<Vec<crate::models::TrialPlSegment3TagsResponseTrialPlSegment3TagsSegment3Tags>>,
    /// 合計行(勘定科目カテゴリーの時のみ含まれる)
    #[serde(rename = "total_line", skip_serializing_if = "Option::is_none")]
    pub total_line: Option<bool>,
}

impl TrialPlSegment3TagsResponseTrialPlSegment3TagsBalances {
    pub fn new() -> TrialPlSegment3TagsResponseTrialPlSegment3TagsBalances {
