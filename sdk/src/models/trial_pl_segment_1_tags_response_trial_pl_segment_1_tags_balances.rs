...
pub struct TrialPlSegment1TagsResponseTrialPlSegment1TagsBalances {
    /// 勘定科目カテゴリー名
    ...
    pub segment_1_tags: Option<Vec<crate::models::TrialPlSegment1TagsResponseTrialPlSegment1TagsSegment1Tags>>,
    /// 合計行(勘定科目カテゴリーの時のみ含まれる)
    #[serde(rename = "total_line", skip_serializing_if = "Option::is_none")]
    pub total_line: Option<bool>,
}

impl TrialPlSegment1TagsResponseTrialPlSegment1TagsBalances {
    pub fn new() -> TrialPlSegment1TagsResponseTrialPlSegment1TagsBalances {
