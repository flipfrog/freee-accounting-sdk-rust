...
pub struct TrialPlSegment2TagsResponseTrialPlSegment2TagsBalances {
    /// 勘定科目カテゴリー名
    ...
    pub segment_2_tags: Option<Vec<crate::models::TrialPlSegment2TagsResponseTrialPlSegment2TagsSegment2Tags>>,
    /// 合計行(勘定科目カテゴリーの時のみ含まれる)
    #[serde(rename = "total_line", skip_serializing_if = "Option::is_none")]
    pub total_line: Option<bool>,
}

impl TrialPlSegment2TagsResponseTrialPlSegment2TagsBalances {
    pub fn new() -> TrialPlSegment2TagsResponseTrialPlSegment2TagsBalances {
