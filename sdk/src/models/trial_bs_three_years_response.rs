...
impl TrialBsThreeYearsResponse {
    pub fn new(trial_bs_three_years: crate::models::TrialBsThreeYearsResponseTrialBsThreeYears, up_to_date: bool) -> TrialBsThreeYearsResponse {
        TrialBsThreeYearsResponse {
            trial_bs_three_years: Box::new(trial_bs_three_years),
            up_to_date,
