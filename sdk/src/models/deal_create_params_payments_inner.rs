...
pub struct DealCreateParamsPaymentsInner {
    /// 支払金額：payments指定時は必須
    #[serde(rename = "amount")]
    pub amount: i64,
...
impl DealCreateParamsPaymentsInner {
    pub fn new(amount: i64, from_walletable_id: i32, from_walletable_type: FromWalletableType, date: String) -> DealCreateParamsPaymentsInner {
