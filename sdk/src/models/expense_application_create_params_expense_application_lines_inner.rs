...
pub struct ExpenseApplicationCreateParamsExpenseApplicationLinesInner {
    /// 日付 (yyyy-mm-dd)
...
impl ExpenseApplicationCreateParamsExpenseApplicationLinesInner {
    pub fn new() -> ExpenseApplicationCreateParamsExpenseApplicationLinesInner {
