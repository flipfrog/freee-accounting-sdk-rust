...
pub struct TrialBsThreeYearsResponseTrialBsThreeYearsBalancesInnerSegment2TagsInner {
    /// セグメント2タグID
    #[serde(rename = "id")]
    pub id: i32,
    /// セグメント2タグ名
...
impl TrialBsThreeYearsResponseTrialBsThreeYearsBalancesInnerSegment2TagsInner {
    pub fn new(id: i32) -> TrialBsThreeYearsResponseTrialBsThreeYearsBalancesInnerSegment2TagsInner {
        TrialBsThreeYearsResponseTrialBsThreeYearsBalancesInnerSegment2TagsInner {
            id,
            name: None,
