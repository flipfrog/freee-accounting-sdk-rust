...
pub struct FixedAssetResponseUpToDateReasonsInner {
    /// コード
    #[serde(rename = "code")]
    pub code: Code,
    /// 集計が最新でない理由
...
impl FixedAssetResponseUpToDateReasonsInner {
    pub fn new(code: Code, message: String) -> FixedAssetResponseUpToDateReasonsInner {
        FixedAssetResponseUpToDateReasonsInner {
            code,
            message,
        }
    }
