...
pub struct TrialBsTwoYearsResponseTrialBsTwoYearsBalancesInnerSectionsInner {
    /// 部門ID
    #[serde(rename = "id")]
    pub id: i32,
    /// 部門名
...
impl TrialBsTwoYearsResponseTrialBsTwoYearsBalancesInnerSectionsInner {
    pub fn new(id: i32) -> TrialBsTwoYearsResponseTrialBsTwoYearsBalancesInnerSectionsInner {
        TrialBsTwoYearsResponseTrialBsTwoYearsBalancesInnerSectionsInner {
            id,
            name: None,
