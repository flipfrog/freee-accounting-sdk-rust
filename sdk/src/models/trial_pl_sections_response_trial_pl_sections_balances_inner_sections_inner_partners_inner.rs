...
pub struct TrialPlSectionsResponseTrialPlSectionsBalancesInnerSectionsInnerPartnersInner {
    /// 取引先ID
    #[serde(rename = "id")]
    pub id: i32,
    /// 取引先名
...
impl TrialPlSectionsResponseTrialPlSectionsBalancesInnerSectionsInnerPartnersInner {
    pub fn new(id: i32) -> TrialPlSectionsResponseTrialPlSectionsBalancesInnerSectionsInnerPartnersInner {
        TrialPlSectionsResponseTrialPlSectionsBalancesInnerSectionsInnerPartnersInner {
            id,
            name: None,
