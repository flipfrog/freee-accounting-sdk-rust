...
pub struct ExpenseApplicationsIndexResponseExpenseApplicationsInnerPurchaseLinesInnerExpenseApplicationLinesInner {
    /// 明細行ID
    #[serde(rename = "id")]
    pub id: i64,
    /// 内容
...
impl ExpenseApplicationsIndexResponseExpenseApplicationsInnerPurchaseLinesInnerExpenseApplicationLinesInner {
    pub fn new(id: i64) -> ExpenseApplicationsIndexResponseExpenseApplicationsInnerPurchaseLinesInnerExpenseApplicationLinesInner {
        ExpenseApplicationsIndexResponseExpenseApplicationsInnerPurchaseLinesInnerExpenseApplicationLinesInner {
            id,
            description: None,
            amount: None,
