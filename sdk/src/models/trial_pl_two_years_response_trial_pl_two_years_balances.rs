...
pub struct TrialPlTwoYearsResponseTrialPlTwoYearsBalances {
    /// 勘定科目カテゴリー名
    ...
    pub sections: Option<Vec<crate::models::TrialPlTwoYearsResponseTrialPlTwoYearsSections>>,
...
impl TrialPlTwoYearsResponseTrialPlTwoYearsBalances {
    pub fn new() -> TrialPlTwoYearsResponseTrialPlTwoYearsBalances {
