...
impl InvoiceResponseInvoice {
    pub fn new(company_id: i32, company_name: String, id: i32, invoice_layout: InvoiceLayout, invoice_number: String, invoice_status: InvoiceStatus, issue_date: String, partner_id: Option<i32>, payment_type: PaymentType, posting_status: PostingStatus, tax_entry_method: TaxEntryMethod, total_amount: i32, total_amount_per_vat_rate: crate::models::InvoiceIndexResponseTotalAmountPerVatRate) -> InvoiceResponseInvoice {
