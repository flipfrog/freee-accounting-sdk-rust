...
pub struct PartnersResponsePartnerBankAccountAttributes {
    /// 銀行名
...
impl PartnersResponsePartnerBankAccountAttributes {
    pub fn new() -> PartnersResponsePartnerBankAccountAttributes {
