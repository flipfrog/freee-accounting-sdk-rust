...
pub struct TrialCrTwoYearsResponseTrialCrTwoYearsItems {
    /// 期末残高
...
impl TrialCrTwoYearsResponseTrialCrTwoYearsItems {
    pub fn new(id: i32) -> TrialCrTwoYearsResponseTrialCrTwoYearsItems {
