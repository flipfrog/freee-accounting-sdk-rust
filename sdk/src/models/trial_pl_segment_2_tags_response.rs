...
pub struct TrialPlSegment2TagsResponse {
    #[serde(rename = "trial_pl_segment_2_tags")]
    pub trial_pl_segment_2_tags: Box<crate::models::TrialPlSegment2TagsResponseTrialPlSegment2Tags>,
    /// 集計結果が最新かどうか
...
impl TrialPlSegment2TagsResponse {
    pub fn new(trial_pl_segment_2_tags: crate::models::TrialPlSegment2TagsResponseTrialPlSegment2Tags, up_to_date: bool) -> TrialPlSegment2TagsResponse {
        TrialPlSegment2TagsResponse {
            trial_pl_segment_2_tags: Box::new(trial_pl_segment_2_tags),
            up_to_date,
