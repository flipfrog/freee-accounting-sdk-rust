...
pub struct TrialCrThreeYearsResponseTrialCrThreeYearsSegment2Tags {
    /// 期末残高
...
impl TrialCrThreeYearsResponseTrialCrThreeYearsSegment2Tags {
    pub fn new(id: i32) -> TrialCrThreeYearsResponseTrialCrThreeYearsSegment2Tags {
