...
pub struct TrialPlSectionsResponseTrialPlSectionsBalancesInnerSectionsInner {
    /// 部門ID
    #[serde(rename = "id")]
    pub id: i32,
    /// 部門名
    ...
    pub partners: Option<Vec<crate::models::TrialPlSectionsResponseTrialPlSectionsBalancesInnerSectionsInnerPartnersInner>>,
    /// breakdown_display_type:item, account_item_display_type:account_item指定時のみ含まれる
    #[serde(rename = "items", skip_serializing_if = "Option::is_none")]
    pub items: Option<Vec<crate::models::TrialPlSectionsResponseTrialPlSectionsBalancesInnerSectionsInnerItemsInner>>,
    ...
    pub segment_1_tags: Option<Vec<crate::models::TrialPlSectionsResponseTrialPlSectionsBalancesInnerSectionsInnerSegment1TagsInner>>,
    ...
    pub segment_2_tags: Option<Vec<crate::models::TrialPlSectionsResponseTrialPlSectionsBalancesInnerSectionsInnerSegment2TagsInner>>,
    ...
    pub segment_3_tags: Option<Vec<crate::models::TrialPlSectionsResponseTrialPlSectionsBalancesInnerSectionsInnerSegment3TagsInner>>,
}

impl TrialPlSectionsResponseTrialPlSectionsBalancesInnerSectionsInner {
    pub fn new(id: i32) -> TrialPlSectionsResponseTrialPlSectionsBalancesInnerSectionsInner {
        TrialPlSectionsResponseTrialPlSectionsBalancesInnerSectionsInner {
            id,
            name: None,
