...
impl TrialPlSectionsResponseTrialPlSections {
    pub fn new(balances: Vec<crate::models::TrialPlSectionsResponseTrialPlSectionsBalances>, company_id: i32, section_ids: String) -> TrialPlSectionsResponseTrialPlSections {
