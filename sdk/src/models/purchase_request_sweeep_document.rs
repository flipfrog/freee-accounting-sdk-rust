...
pub struct PurchaseRequestSweeepDocument {
    /// 購買申請ID
...
impl PurchaseRequestSweeepDocument {
    pub fn new(purchase_request_id: i32, company_id: i32, sweeep_document_id: String, sweeep_document_code: String, sweeep_document_path: String, amount: i32) -> PurchaseRequestSweeepDocument {
        PurchaseRequestSweeepDocument {
            purchase_request_id,
            company_id,
            sweeep_document_id,
