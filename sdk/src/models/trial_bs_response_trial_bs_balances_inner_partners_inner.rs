...
pub struct TrialBsResponseTrialBsBalancesInnerPartnersInner {
    /// 取引先ID
    #[serde(rename = "id")]
    pub id: i32,
    /// 取引先名
...
impl TrialBsResponseTrialBsBalancesInnerPartnersInner {
    pub fn new(id: i32) -> TrialBsResponseTrialBsBalancesInnerPartnersInner {
        TrialBsResponseTrialBsBalancesInnerPartnersInner {
            id,
            name: None,
