...
pub struct ApprovalRequestsIndexResponseApprovalRequestsInner {
    /// 各種申請ID
    #[serde(rename = "id")]
    pub id: i32,
    /// 事業所ID
...
impl ApprovalRequestsIndexResponseApprovalRequestsInner {
    pub fn new(id: i32, company_id: i32, application_date: String, title: String, applicant_id: i32, application_number: String, status: Status, request_items: Vec<crate::models::ApprovalRequestsIndexResponseApprovalRequestsInnerRequestItemsInner>, form_id: i32, current_step_id: Option<i32>, current_round: i32, deal_id: Option<i32>, manual_journal_id: Option<i32>, deal_status: Option<DealStatus>) -> ApprovalRequestsIndexResponseApprovalRequestsInner {
