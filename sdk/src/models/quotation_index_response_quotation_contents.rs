...
pub struct QuotationIndexResponseQuotationContents {
    /// 勘定科目ID
...
impl QuotationIndexResponseQuotationContents {
    pub fn new(account_item_id: Option<i32>, account_item_name: Option<String>, amount: i32, description: Option<String>, id: i32, item_id: Option<i32>, item_name: Option<String>, order: i32, qty: f32, reduced_vat: bool, section_id: Option<i32>, section_name: Option<String>, tag_ids: Vec<i32>, tag_names: Vec<String>, tax_code: Option<i32>, _type: Type, unit: Option<String>, unit_price: f32, vat: i32) -> QuotationIndexResponseQuotationContents {
