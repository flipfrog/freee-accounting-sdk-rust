...
impl QuotationIndexResponseQuotationContents {
    pub fn new(id: i32, order: i32, _type: Type, qty: f32, unit: Option<String>, unit_price: f32, amount: i32, vat: i32, reduced_vat: bool, description: Option<String>, account_item_id: Option<i32>, account_item_name: Option<String>, tax_code: Option<i32>, item_id: Option<i32>, item_name: Option<String>, section_id: Option<i32>, section_name: Option<String>, tag_ids: Vec<i32>, tag_names: Vec<String>) -> QuotationIndexResponseQuotationContents {
