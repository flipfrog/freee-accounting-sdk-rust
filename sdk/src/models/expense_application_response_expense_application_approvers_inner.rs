...
pub struct ExpenseApplicationResponseExpenseApplicationApproversInner {
    /// 承認ステップID
    ...
    pub status: Status,
    /// 代理承認済みかどうか
    #[serde(rename = "is_force_action")]
    pub is_force_action: bool,
...
impl ExpenseApplicationResponseExpenseApplicationApproversInner {
    pub fn new(step_id: i32, user_id: Option<i32>, status: Status, is_force_action: bool, resource_type: ResourceType) -> ExpenseApplicationResponseExpenseApplicationApproversInner {
        ExpenseApplicationResponseExpenseApplicationApproversInner {
            step_id,
            user_id,
            status,
            is_force_action,
...
pub enum ResourceType {
    #[serde(rename = "predefined_user")]
    PredefinedUser,
    #[serde(rename = "selected_user")]
    SelectedUser,
    #[serde(rename = "unspecified")]
    Unspecified,
    #[serde(rename = "and_resource")]
    AndResource,
    #[serde(rename = "or_resource")]
    OrResource,
    #[serde(rename = "and_position")]
    AndPosition,
