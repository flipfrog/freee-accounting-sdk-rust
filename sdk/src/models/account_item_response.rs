...
pub struct AccountItemResponse {
    #[serde(rename = "account_item")]
    pub account_item: Box<crate::models::AccountItemResponseAccountItem>,
}

impl AccountItemResponse {
    pub fn new(account_item: crate::models::AccountItemResponseAccountItem) -> AccountItemResponse {
        AccountItemResponse {
