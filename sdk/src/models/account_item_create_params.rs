...
pub struct AccountItemCreateParams {
    /// 事業所ID
    #[serde(rename = "company_id")]
    pub company_id: i32,
    #[serde(rename = "account_item")]
    pub account_item: Box<crate::models::AccountItemCreateParamsAccountItem>,
}

impl AccountItemCreateParams {
    pub fn new(company_id: i32, account_item: crate::models::AccountItemCreateParamsAccountItem) -> AccountItemCreateParams {
