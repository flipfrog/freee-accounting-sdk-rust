...
pub struct ApprovalRequestFormResponse {
    #[serde(rename = "approval_request_form")]
    pub approval_request_form: Box<crate::models::ApprovalRequestFormResponseApprovalRequestForm>,
}

impl ApprovalRequestFormResponse {
    pub fn new(approval_request_form: crate::models::ApprovalRequestFormResponseApprovalRequestForm) -> ApprovalRequestFormResponse {
