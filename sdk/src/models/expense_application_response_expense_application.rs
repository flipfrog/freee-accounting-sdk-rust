...
impl ExpenseApplicationResponseExpenseApplication {
    pub fn new(applicant_id: i32, application_number: String, approval_flow_logs: Vec<crate::models::ApprovalRequestResponseApprovalRequestApprovalFlowLogs>, approval_flow_route_id: i32, approvers: Vec<crate::models::ApprovalRequestResponseApprovalRequestApprovers>, comments: Vec<crate::models::ApprovalRequestResponseApprovalRequestComments>, company_id: i32, current_round: i32, current_step_id: Option<i32>, deal_id: Option<i32>, deal_status: Option<DealStatus>, expense_application_lines: Vec<crate::models::ExpenseApplicationResponseExpenseApplicationExpenseApplicationLines>, id: i32, issue_date: String, status: Status, title: String) -> ExpenseApplicationResponseExpenseApplication {
