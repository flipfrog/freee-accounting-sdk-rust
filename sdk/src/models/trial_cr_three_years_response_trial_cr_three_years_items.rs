...
pub struct TrialCrThreeYearsResponseTrialCrThreeYearsItems {
    /// 期末残高
...
impl TrialCrThreeYearsResponseTrialCrThreeYearsItems {
    pub fn new(id: i32) -> TrialCrThreeYearsResponseTrialCrThreeYearsItems {
