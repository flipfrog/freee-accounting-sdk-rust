...
pub struct TrialCrResponseTrialCrBalances {
    ...
    pub segment_1_tags: Option<Vec<crate::models::TrialCrResponseTrialCrSegment1Tags>>,
    ...
    pub segment_2_tags: Option<Vec<crate::models::TrialCrResponseTrialCrSegment2Tags>>,
