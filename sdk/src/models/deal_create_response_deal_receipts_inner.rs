...
impl DealCreateResponseDealReceiptsInner {
    pub fn new(id: i32, status: Status, mime_type: String, origin: Origin, created_at: String, user: crate::models::DealCreateResponseDealReceiptsInnerUser) -> DealCreateResponseDealReceiptsInner {
