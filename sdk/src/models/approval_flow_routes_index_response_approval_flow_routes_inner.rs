...
pub struct ApprovalFlowRoutesIndexResponseApprovalFlowRoutesInner {
    /// 申請経路ID
    #[serde(rename = "id")]
    pub id: i32,
    /// 申請経路名
    ...
    #[serde(rename = "request_form_ids", skip_serializing_if = "Option::is_none")]
    pub request_form_ids: Option<Vec<i32>>,
    ...
    #[serde(rename = "default_route")]
    pub default_route: bool,
}

impl ApprovalFlowRoutesIndexResponseApprovalFlowRoutesInner {
    pub fn new(id: i32, default_route: bool) -> ApprovalFlowRoutesIndexResponseApprovalFlowRoutesInner {
...
pub enum Usages {
    #[serde(rename = "TxnApproval")]
    TxnApproval,
    #[serde(rename = "ExpenseApplication")]
    ExpenseApplication,
