...
pub struct CompanyResponseCompanyWalletablesInner {
    /// 口座ID
    #[serde(rename = "id")]
    pub id: i32,
    /// 口座名 (255文字以内)
...
impl CompanyResponseCompanyWalletablesInner {
    pub fn new(id: i32, name: String, r#type: RHashType) -> CompanyResponseCompanyWalletablesInner {
