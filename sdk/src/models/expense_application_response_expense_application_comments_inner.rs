...
pub struct ExpenseApplicationResponseExpenseApplicationCommentsInner {
    /// コメント内容
...
impl ExpenseApplicationResponseExpenseApplicationCommentsInner {
    pub fn new(comment: String, user_id: i32, posted_at: String) -> ExpenseApplicationResponseExpenseApplicationCommentsInner {
        ExpenseApplicationResponseExpenseApplicationCommentsInner {
            comment,
            user_id,
            posted_at,
        }
