...
pub struct TrialPlSegment2TagsResponseTrialPlSegment2TagsBalancesInnerSegment2TagsInner {
    /// セグメント2タグID
    #[serde(rename = "id")]
    pub id: i32,
    /// セグメント2タグ名
    ...
    pub sections: Option<Vec<crate::models::TrialPlSegment1TagsResponseTrialPlSegment1TagsBalancesInnerSegment1TagsInnerSectionsInner>>,
}

impl TrialPlSegment2TagsResponseTrialPlSegment2TagsBalancesInnerSegment2TagsInner {
    pub fn new(id: i32) -> TrialPlSegment2TagsResponseTrialPlSegment2TagsBalancesInnerSegment2TagsInner {
        TrialPlSegment2TagsResponseTrialPlSegment2TagsBalancesInnerSegment2TagsInner {
            id,
            name: None,
