...
pub struct DealCreateParamsDetailsInner {
    /// 税区分コード
...
impl DealCreateParamsDetailsInner {
    pub fn new(tax_code: i32, account_item_id: i32, amount: i64) -> DealCreateParamsDetailsInner {
