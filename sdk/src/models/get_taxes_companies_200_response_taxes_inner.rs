...
pub struct GetTaxesCompanies200ResponseTaxesInner {
    /// 税区分コード
    #[serde(rename = "code")]
    pub code: i32,
    /// 税区分名
...
impl GetTaxesCompanies200ResponseTaxesInner {
    pub fn new(code: i32, name: String, name_ja: String, display_category: Option<DisplayCategory>, available: bool) -> GetTaxesCompanies200ResponseTaxesInner {
