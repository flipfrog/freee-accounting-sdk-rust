...
pub struct TrialBsResponseTrialBs {
    /// 事業所ID
...
impl TrialBsResponseTrialBs {
    pub fn new(company_id: i32, balances: Vec<crate::models::TrialBsResponseTrialBsBalancesInner>) -> TrialBsResponseTrialBs {
