...
pub struct TrialBsResponseTrialBsBalancesInnerItemsInner {
    /// 品目ID
    #[serde(rename = "id")]
    pub id: i32,
    /// 品目
...
impl TrialBsResponseTrialBsBalancesInnerItemsInner {
    pub fn new(id: i32) -> TrialBsResponseTrialBsBalancesInnerItemsInner {
        TrialBsResponseTrialBsBalancesInnerItemsInner {
            id,
            name: None,
