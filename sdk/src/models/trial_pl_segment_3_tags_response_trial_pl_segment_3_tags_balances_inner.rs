...
pub struct TrialPlSegment3TagsResponseTrialPlSegment3TagsBalancesInner {
    /// 勘定科目ID(勘定科目の時のみ含まれる)
    ...
    pub segment_3_tags: Option<Vec<crate::models::TrialPlSegment3TagsResponseTrialPlSegment3TagsBalancesInnerSegment3TagsInner>>,
    /// 勘定科目カテゴリー名
...
impl TrialPlSegment3TagsResponseTrialPlSegment3TagsBalancesInner {
    pub fn new() -> TrialPlSegment3TagsResponseTrialPlSegment3TagsBalancesInner {
        TrialPlSegment3TagsResponseTrialPlSegment3TagsBalancesInner {
