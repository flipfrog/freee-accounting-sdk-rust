...
pub struct TrialPlSectionsResponseTrialPlSectionsBalancesInnerSectionsInnerSegment3TagsInner {
    /// セグメント3タグID
    #[serde(rename = "id")]
    pub id: i32,
    /// セグメント3タグ名
...
impl TrialPlSectionsResponseTrialPlSectionsBalancesInnerSectionsInnerSegment3TagsInner {
    pub fn new(id: i32) -> TrialPlSectionsResponseTrialPlSectionsBalancesInnerSectionsInnerSegment3TagsInner {
        TrialPlSectionsResponseTrialPlSectionsBalancesInnerSectionsInnerSegment3TagsInner {
            id,
            name: None,
