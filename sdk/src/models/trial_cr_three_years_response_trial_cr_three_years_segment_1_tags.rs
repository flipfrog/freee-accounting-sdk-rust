...
pub struct TrialCrThreeYearsResponseTrialCrThreeYearsSegment1Tags {
    /// 期末残高
...
impl TrialCrThreeYearsResponseTrialCrThreeYearsSegment1Tags {
    pub fn new(id: i32) -> TrialCrThreeYearsResponseTrialCrThreeYearsSegment1Tags {
