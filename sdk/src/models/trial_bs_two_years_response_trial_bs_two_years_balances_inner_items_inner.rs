...
pub struct TrialBsTwoYearsResponseTrialBsTwoYearsBalancesInnerItemsInner {
    /// 品目ID
    #[serde(rename = "id")]
    pub id: i32,
    /// 品目
...
impl TrialBsTwoYearsResponseTrialBsTwoYearsBalancesInnerItemsInner {
    pub fn new(id: i32) -> TrialBsTwoYearsResponseTrialBsTwoYearsBalancesInnerItemsInner {
        TrialBsTwoYearsResponseTrialBsTwoYearsBalancesInnerItemsInner {
            id,
            name: None,
