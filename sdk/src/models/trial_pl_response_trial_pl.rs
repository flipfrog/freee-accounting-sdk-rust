...
pub struct TrialPlResponseTrialPl {
    ...
    pub balances: Vec<crate::models::TrialPlResponseTrialPlBalances>,
...
impl TrialPlResponseTrialPl {
    pub fn new(balances: Vec<crate::models::TrialPlResponseTrialPlBalances>, company_id: i32) -> TrialPlResponseTrialPl {
