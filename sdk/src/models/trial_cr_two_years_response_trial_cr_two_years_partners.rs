...
pub struct TrialCrTwoYearsResponseTrialCrTwoYearsPartners {
    /// 期末残高
...
impl TrialCrTwoYearsResponseTrialCrTwoYearsPartners {
    pub fn new(id: i32) -> TrialCrTwoYearsResponseTrialCrTwoYearsPartners {
