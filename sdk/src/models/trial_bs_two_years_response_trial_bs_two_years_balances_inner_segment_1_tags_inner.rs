...
pub struct TrialBsTwoYearsResponseTrialBsTwoYearsBalancesInnerSegment1TagsInner {
    /// セグメント1タグID
    #[serde(rename = "id")]
    pub id: i32,
    /// セグメント1タグ名
...
impl TrialBsTwoYearsResponseTrialBsTwoYearsBalancesInnerSegment1TagsInner {
    pub fn new(id: i32) -> TrialBsTwoYearsResponseTrialBsTwoYearsBalancesInnerSegment1TagsInner {
        TrialBsTwoYearsResponseTrialBsTwoYearsBalancesInnerSegment1TagsInner {
            id,
            name: None,
