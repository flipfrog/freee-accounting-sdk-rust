...
pub struct TrialPlThreeYearsResponseTrialPlThreeYears {
    /// 事業所ID
...
impl TrialPlThreeYearsResponseTrialPlThreeYears {
    pub fn new(company_id: i32, balances: Vec<crate::models::TrialBsThreeYearsResponseTrialBsThreeYearsBalancesInner>) -> TrialPlThreeYearsResponseTrialPlThreeYears {
