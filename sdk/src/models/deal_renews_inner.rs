...
pub struct DealRenewsInner {
    ...
    pub details: Vec<crate::models::DealRenewsInnerDetailsInner>,
}

impl DealRenewsInner {
    pub fn new(id: i64, update_date: String, renew_target_id: i64, renew_target_type: RenewTargetType, details: Vec<crate::models::DealRenewsInnerDetailsInner>) -> DealRenewsInner {
        DealRenewsInner {
            id,
            update_date,
            renew_target_id,
...
impl Default for RenewTargetType {
    fn default() -> RenewTargetType {
        Self::Detail
    }
}
