...
pub struct TrialCrSegment1TagsResponseTrialCrSegment1TagsBalances {
    /// 勘定科目カテゴリー名
    ...
    pub segment_1_tags: Option<Vec<crate::models::TrialCrSegment1TagsResponseTrialCrSegment1TagsSegment1Tags>>,
    /// 合計行(勘定科目カテゴリーの時のみ含まれる)
    #[serde(rename = "total_line", skip_serializing_if = "Option::is_none")]
    pub total_line: Option<bool>,
}

impl TrialCrSegment1TagsResponseTrialCrSegment1TagsBalances {
    pub fn new() -> TrialCrSegment1TagsResponseTrialCrSegment1TagsBalances {
