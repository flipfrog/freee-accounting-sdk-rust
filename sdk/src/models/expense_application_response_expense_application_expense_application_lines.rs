...
pub struct ExpenseApplicationResponseExpenseApplicationExpenseApplicationLines {
    /// 金額
...
impl ExpenseApplicationResponseExpenseApplicationExpenseApplicationLines {
    pub fn new(id: i64) -> ExpenseApplicationResponseExpenseApplicationExpenseApplicationLines {
