...
pub struct InvoiceUpdateParamsInvoiceContents {
    /// 勘定科目ID
...
impl InvoiceUpdateParamsInvoiceContents {
    pub fn new(order: i32, _type: Type) -> InvoiceUpdateParamsInvoiceContents {
