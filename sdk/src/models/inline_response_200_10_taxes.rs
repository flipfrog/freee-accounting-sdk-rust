...
pub struct InlineResponse20010Taxes {
...
impl InlineResponse20010Taxes {
    pub fn new(available: bool, code: i32, display_category: Option<DisplayCategory>, name: String, name_ja: String) -> InlineResponse20010Taxes {
