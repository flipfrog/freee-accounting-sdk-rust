...
pub struct TrialBsResponseTrialBsBalancesInnerSegment3TagsInner {
    /// セグメント3タグID
    #[serde(rename = "id")]
    pub id: i32,
    /// セグメント3タグ名
...
impl TrialBsResponseTrialBsBalancesInnerSegment3TagsInner {
    pub fn new(id: i32) -> TrialBsResponseTrialBsBalancesInnerSegment3TagsInner {
        TrialBsResponseTrialBsBalancesInnerSegment3TagsInner {
            id,
            name: None,
