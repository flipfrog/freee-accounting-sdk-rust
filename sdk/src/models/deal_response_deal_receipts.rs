...
pub struct DealResponseDealReceipts {
    /// 作成日時（ISO8601形式）
...
impl DealResponseDealReceipts {
    pub fn new(created_at: String, file_src: String, id: i32, mime_type: String, origin: Origin, status: Status, user: crate::models::DealResponseDealUser) -> DealResponseDealReceipts {
