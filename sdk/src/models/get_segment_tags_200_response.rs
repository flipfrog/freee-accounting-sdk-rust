...
pub struct GetSegmentTags200Response {
    #[serde(rename = "segment_tags")]
    pub segment_tags: Vec<crate::models::SegmentTag>,
}

impl GetSegmentTags200Response {
    pub fn new(segment_tags: Vec<crate::models::SegmentTag>) -> GetSegmentTags200Response {
        GetSegmentTags200Response {
            segment_tags,
        }
    }
}
