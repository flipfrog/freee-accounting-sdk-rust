...
pub struct PartnersResponseAddressAttributes {
    ...
    /// 市区町村・番地
    #[serde(rename = "street_name1", skip_serializing_if = "Option::is_none")]
    pub street_name1: Option<String>,
    /// 建物名・部屋番号など
    #[serde(rename = "street_name2", skip_serializing_if = "Option::is_none")]
...
impl PartnersResponseAddressAttributes {
    pub fn new() -> PartnersResponseAddressAttributes {
