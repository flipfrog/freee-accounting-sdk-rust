...
pub struct QuotationUpdateParams {
    /// 事業所ID
    ...
    #[serde(rename = "quotation_number", skip_serializing_if = "Option::is_none")]
    ...
    #[serde(rename = "quotation_layout", skip_serializing_if = "Option::is_none")]
    pub quotation_layout: Option<QuotationLayout>,
    ...
    pub quotation_contents: Option<Vec<crate::models::QuotationUpdateParamsQuotationContentsInner>>,
}

impl QuotationUpdateParams {
    pub fn new(company_id: i32, partner_display_name: String, partner_title: String) -> QuotationUpdateParams {
...
impl Default for QuotationLayout {
    fn default() -> QuotationLayout {
        Self::DefaultClassic
    }
}
/// 見積書の消費税計算方法(inclusive: 内税表示, exclusive: 外税表示 (デフォルト))
