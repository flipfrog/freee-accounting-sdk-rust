...
pub struct InvoiceIndexResponseInvoicesInner {
    /// 請求書ID
    #[serde(rename = "id")]
    pub id: i32,
    /// 事業所ID
...
impl InvoiceIndexResponseInvoicesInner {
    pub fn new(id: i32, company_id: i32, issue_date: String, partner_id: Option<i32>, invoice_number: String, total_amount: i32, invoice_status: InvoiceStatus, posting_status: PostingStatus, company_name: String, payment_type: PaymentType, invoice_layout: InvoiceLayout, tax_entry_method: TaxEntryMethod, total_amount_per_vat_rate: crate::models::InvoiceIndexResponseInvoicesInnerTotalAmountPerVatRate) -> InvoiceIndexResponseInvoicesInner {
