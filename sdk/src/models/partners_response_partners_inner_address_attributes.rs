...
pub struct PartnersResponsePartnersInnerAddressAttributes {
    /// 郵便番号
...
impl PartnersResponsePartnersInnerAddressAttributes {
    pub fn new() -> PartnersResponsePartnersInnerAddressAttributes {
