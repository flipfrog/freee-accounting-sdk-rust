...
pub struct TrialBsResponseTrialBsBalancesInnerSegment1TagsInner {
    /// セグメント1タグID
    #[serde(rename = "id")]
    pub id: i32,
    /// セグメント1タグ名
...
impl TrialBsResponseTrialBsBalancesInnerSegment1TagsInner {
    pub fn new(id: i32) -> TrialBsResponseTrialBsBalancesInnerSegment1TagsInner {
        TrialBsResponseTrialBsBalancesInnerSegment1TagsInner {
            id,
            name: None,
