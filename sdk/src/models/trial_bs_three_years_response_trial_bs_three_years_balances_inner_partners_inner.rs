...
pub struct TrialBsThreeYearsResponseTrialBsThreeYearsBalancesInnerPartnersInner {
    /// 取引先ID
    #[serde(rename = "id")]
    pub id: i32,
    /// 取引先名
...
impl TrialBsThreeYearsResponseTrialBsThreeYearsBalancesInnerPartnersInner {
    pub fn new(id: i32) -> TrialBsThreeYearsResponseTrialBsThreeYearsBalancesInnerPartnersInner {
        TrialBsThreeYearsResponseTrialBsThreeYearsBalancesInnerPartnersInner {
            id,
            name: None,
