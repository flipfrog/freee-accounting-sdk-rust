...
pub struct FixedAssetResponseFixedAssetsInner {
    /// 事業所ID
    ...
    /// 未償却残高
    #[serde(rename = "undepreciated_balance", skip_serializing_if = "Option::is_none")]
    pub undepreciated_balance: Option<i32>,
    /// 期首減価償却累計額
...
impl FixedAssetResponseFixedAssetsInner {
    pub fn new() -> FixedAssetResponseFixedAssetsInner {
