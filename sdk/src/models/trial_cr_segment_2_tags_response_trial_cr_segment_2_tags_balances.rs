...
pub struct TrialCrSegment2TagsResponseTrialCrSegment2TagsBalances {
    /// 勘定科目カテゴリー名
    ...
    pub segment_2_tags: Option<Vec<crate::models::TrialCrSegment2TagsResponseTrialCrSegment2TagsSegment2Tags>>,
    /// 合計行(勘定科目カテゴリーの時のみ含まれる)
    #[serde(rename = "total_line", skip_serializing_if = "Option::is_none")]
    pub total_line: Option<bool>,
}

impl TrialCrSegment2TagsResponseTrialCrSegment2TagsBalances {
    pub fn new() -> TrialCrSegment2TagsResponseTrialCrSegment2TagsBalances {
