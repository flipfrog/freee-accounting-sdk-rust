...
pub struct TrialPlSegment2TagsResponseTrialPlSegment2TagsBalancesInner {
    /// 勘定科目ID(勘定科目の時のみ含まれる)
    ...
    pub segment_2_tags: Option<Vec<crate::models::TrialPlSegment2TagsResponseTrialPlSegment2TagsBalancesInnerSegment2TagsInner>>,
    /// 勘定科目カテゴリー名
...
impl TrialPlSegment2TagsResponseTrialPlSegment2TagsBalancesInner {
    pub fn new() -> TrialPlSegment2TagsResponseTrialPlSegment2TagsBalancesInner {
        TrialPlSegment2TagsResponseTrialPlSegment2TagsBalancesInner {
