...
pub struct TrialPlTwoYearsResponse {
    #[serde(rename = "trial_pl_two_years")]
    pub trial_pl_two_years: Box<crate::models::TrialPlTwoYearsResponseTrialPlTwoYears>,
    /// 集計結果が最新かどうか
...
impl TrialPlTwoYearsResponse {
    pub fn new(trial_pl_two_years: crate::models::TrialPlTwoYearsResponseTrialPlTwoYears, up_to_date: bool) -> TrialPlTwoYearsResponse {
        TrialPlTwoYearsResponse {
            trial_pl_two_years: Box::new(trial_pl_two_years),
            up_to_date,
