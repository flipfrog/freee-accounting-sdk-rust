...
pub struct TrialPlTwoYearsResponseTrialPlTwoYearsSections {
    /// 期末残高
...
impl TrialPlTwoYearsResponseTrialPlTwoYearsSections {
    pub fn new(id: i32) -> TrialPlTwoYearsResponseTrialPlTwoYearsSections {
