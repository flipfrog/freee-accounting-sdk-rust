...
pub struct TrialBsThreeYearsResponseTrialBsThreeYearsBalancesInnerSectionsInner {
    /// 部門ID
    #[serde(rename = "id")]
    pub id: i32,
    /// 部門名
...
impl TrialBsThreeYearsResponseTrialBsThreeYearsBalancesInnerSectionsInner {
    pub fn new(id: i32) -> TrialBsThreeYearsResponseTrialBsThreeYearsBalancesInnerSectionsInner {
        TrialBsThreeYearsResponseTrialBsThreeYearsBalancesInnerSectionsInner {
            id,
            name: None,
