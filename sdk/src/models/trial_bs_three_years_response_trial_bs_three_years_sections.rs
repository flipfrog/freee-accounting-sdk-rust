...
pub struct TrialBsThreeYearsResponseTrialBsThreeYearsSections {
    /// 期末残高
...
impl TrialBsThreeYearsResponseTrialBsThreeYearsSections {
    pub fn new(id: i32) -> TrialBsThreeYearsResponseTrialBsThreeYearsSections {
