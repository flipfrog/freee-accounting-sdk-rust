...
pub struct SelectablesIndexResponseAccountGroupsInner {
    /// 決算書表示名（小カテゴリー）ID
    #[serde(rename = "id")]
    pub id: i32,
    /// 決算書表示名
...
impl SelectablesIndexResponseAccountGroupsInner {
    pub fn new(id: i32, name: String, account_structure_id: i32, account_category_id: i32, index: i32) -> SelectablesIndexResponseAccountGroupsInner {
        SelectablesIndexResponseAccountGroupsInner {
            id,
            name,
