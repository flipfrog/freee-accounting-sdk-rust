...
pub struct TrialPlThreeYearsResponse {
    #[serde(rename = "trial_pl_three_years")]
    pub trial_pl_three_years: Box<crate::models::TrialPlThreeYearsResponseTrialPlThreeYears>,
    /// 集計結果が最新かどうか
...
impl TrialPlThreeYearsResponse {
    pub fn new(trial_pl_three_years: crate::models::TrialPlThreeYearsResponseTrialPlThreeYears, up_to_date: bool) -> TrialPlThreeYearsResponse {
        TrialPlThreeYearsResponse {
            trial_pl_three_years: Box::new(trial_pl_three_years),
            up_to_date,
