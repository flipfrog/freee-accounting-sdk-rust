...
pub struct DealRenewsInnerDetailsInner {
    /// +更新の明細行ID
    #[serde(rename = "id")]
    pub id: i64,
...
impl DealRenewsInnerDetailsInner {
    pub fn new(id: i64, entry_side: EntrySide, account_item_id: i32, tax_code: i32, tag_ids: Vec<i32>, amount: i64, vat: i32) -> DealRenewsInnerDetailsInner {
