...
pub struct TrialBsThreeYearsResponseTrialBsThreeYearsBalancesInnerItemsInner {
    /// 品目ID
    #[serde(rename = "id")]
    pub id: i32,
    /// 品目
...
impl TrialBsThreeYearsResponseTrialBsThreeYearsBalancesInnerItemsInner {
    pub fn new(id: i32) -> TrialBsThreeYearsResponseTrialBsThreeYearsBalancesInnerItemsInner {
        TrialBsThreeYearsResponseTrialBsThreeYearsBalancesInnerItemsInner {
            id,
            name: None,
