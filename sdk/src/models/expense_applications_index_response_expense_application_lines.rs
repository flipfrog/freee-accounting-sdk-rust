...
pub struct ExpenseApplicationsIndexResponseExpenseApplicationLines {
    /// 金額
...
impl ExpenseApplicationsIndexResponseExpenseApplicationLines {
    pub fn new(id: i64) -> ExpenseApplicationsIndexResponseExpenseApplicationLines {
