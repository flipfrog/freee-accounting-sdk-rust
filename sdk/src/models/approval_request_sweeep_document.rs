...
pub struct ApprovalRequestSweeepDocument {
    /// 各種申請ID
    #[serde(rename = "approval_request_id")]
    pub approval_request_id: i32,
    /// 事業所ID
    #[serde(rename = "company_id")]
    pub company_id: i32,
    /// sweeepの請求書ID
    #[serde(rename = "sweeep_document_id")]
    pub sweeep_document_id: String,
    /// 表示用の書類コード
    #[serde(rename = "sweeep_document_code")]
    pub sweeep_document_code: String,
    /// リンク用パス
    #[serde(rename = "sweeep_document_path")]
    pub sweeep_document_path: String,
}

impl ApprovalRequestSweeepDocument {
    pub fn new(approval_request_id: i32, company_id: i32, sweeep_document_id: String, sweeep_document_code: String, sweeep_document_path: String) -> ApprovalRequestSweeepDocument {
        ApprovalRequestSweeepDocument {
            approval_request_id,
            company_id,
            sweeep_document_id,
            sweeep_document_code,
            sweeep_document_path,
        }
    }
}
