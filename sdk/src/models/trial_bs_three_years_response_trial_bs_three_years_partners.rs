...
pub struct TrialBsThreeYearsResponseTrialBsThreeYearsPartners {
    /// 期末残高
...
impl TrialBsThreeYearsResponseTrialBsThreeYearsPartners {
    pub fn new(id: i32) -> TrialBsThreeYearsResponseTrialBsThreeYearsPartners {
