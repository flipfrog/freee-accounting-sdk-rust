...
pub struct DealCreateResponseDealDetailsInner {
    /// 取引行ID
    #[serde(rename = "id")]
    pub id: i64,
    /// 勘定科目ID
...
impl DealCreateResponseDealDetailsInner {
    pub fn new(id: i64, account_item_id: i32, tax_code: i32, amount: i64, vat: i32, entry_side: EntrySide) -> DealCreateResponseDealDetailsInner {
        DealCreateResponseDealDetailsInner {
            id,
            account_item_id,
            tax_code,
            item_id: None,
