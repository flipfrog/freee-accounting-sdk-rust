...
pub struct SelectablesIndexResponseAccountCategoriesInnerAccountItemsInner {
    /// 勘定科目ID
    #[serde(rename = "id")]
    pub id: i32,
    /// 勘定科目
    ...
    pub default_tax: Option<Box<crate::models::SelectablesIndexResponseAccountCategoriesInnerAccountItemsInnerDefaultTax>>,
}

impl SelectablesIndexResponseAccountCategoriesInnerAccountItemsInner {
    pub fn new(id: i32) -> SelectablesIndexResponseAccountCategoriesInnerAccountItemsInner {
        SelectablesIndexResponseAccountCategoriesInnerAccountItemsInner {
            id,
            name: None,
            desc: None,
            help: None,
