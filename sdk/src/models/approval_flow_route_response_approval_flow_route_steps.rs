...
impl ApprovalFlowRouteResponseApprovalFlowRouteSteps {
    pub fn new(id: i32, next_step_id: Option<i32>, resource_type: ResourceType) -> ApprovalFlowRouteResponseApprovalFlowRouteSteps {
