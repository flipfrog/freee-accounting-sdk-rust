...
impl ExpenseApplicationsIndexResponseExpenseApplicationsInner {
    pub fn new(id: i32, company_id: i32, title: String, issue_date: String, status: Status, expense_application_lines: Vec<crate::models::ExpenseApplicationsIndexResponseExpenseApplicationsInnerExpenseApplicationLinesInner>, deal_id: Option<i32>, deal_status: Option<DealStatus>, applicant_id: i32, application_number: String) -> ExpenseApplicationsIndexResponseExpenseApplicationsInner {
