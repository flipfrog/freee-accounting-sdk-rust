...
pub struct PaymentRequestActionCreateParams {
    /// 事業所ID
...
impl PaymentRequestActionCreateParams {
    pub fn new(company_id: i32, approval_action: ApprovalAction, target_step_id: i32, target_round: i32) -> PaymentRequestActionCreateParams {
