...
pub struct AccountItemResponseAccountItem {
    ...
    #[serde(rename = "accumulated_dep_account_item_id", default, with = "::serde_with::rust::double_option", skip_serializing_if = "Option::is_none")]
    pub accumulated_dep_account_item_id: Option<Option<i32>>,
