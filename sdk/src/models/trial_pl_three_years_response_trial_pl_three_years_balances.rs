...
pub struct TrialPlThreeYearsResponseTrialPlThreeYearsBalances {
    /// 勘定科目カテゴリー名
    ...
    pub sections: Option<Vec<crate::models::TrialPlThreeYearsResponseTrialPlThreeYearsSections>>,
    ...
    pub segment_1_tags: Option<Vec<crate::models::TrialBsThreeYearsResponseTrialBsThreeYearsSegment1Tags>>,
    ...
    pub segment_2_tags: Option<Vec<crate::models::TrialBsThreeYearsResponseTrialBsThreeYearsSegment2Tags>>,
...
impl TrialPlThreeYearsResponseTrialPlThreeYearsBalances {
    pub fn new() -> TrialPlThreeYearsResponseTrialPlThreeYearsBalances {
