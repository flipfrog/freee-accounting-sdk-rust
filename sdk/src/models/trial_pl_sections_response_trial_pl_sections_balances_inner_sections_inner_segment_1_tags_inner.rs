...
pub struct TrialPlSectionsResponseTrialPlSectionsBalancesInnerSectionsInnerSegment1TagsInner {
    /// セグメント1タグID
    #[serde(rename = "id")]
    pub id: i32,
    /// セグメント1タグ名
...
impl TrialPlSectionsResponseTrialPlSectionsBalancesInnerSectionsInnerSegment1TagsInner {
    pub fn new(id: i32) -> TrialPlSectionsResponseTrialPlSectionsBalancesInnerSectionsInnerSegment1TagsInner {
        TrialPlSectionsResponseTrialPlSectionsBalancesInnerSectionsInnerSegment1TagsInner {
            id,
            name: None,
