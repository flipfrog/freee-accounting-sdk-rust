...
pub struct TrialBsThreeYearsResponseTrialBsThreeYearsBalancesInnerSegment1TagsInner {
    /// セグメント1タグID
    #[serde(rename = "id")]
    pub id: i32,
    /// セグメント1タグ名
...
impl TrialBsThreeYearsResponseTrialBsThreeYearsBalancesInnerSegment1TagsInner {
    pub fn new(id: i32) -> TrialBsThreeYearsResponseTrialBsThreeYearsBalancesInnerSegment1TagsInner {
        TrialBsThreeYearsResponseTrialBsThreeYearsBalancesInnerSegment1TagsInner {
            id,
            name: None,
