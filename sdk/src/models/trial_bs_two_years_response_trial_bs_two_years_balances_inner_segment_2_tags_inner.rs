...
pub struct TrialBsTwoYearsResponseTrialBsTwoYearsBalancesInnerSegment2TagsInner {
    /// セグメント2タグID
    #[serde(rename = "id")]
    pub id: i32,
    /// セグメント2タグ名
...
impl TrialBsTwoYearsResponseTrialBsTwoYearsBalancesInnerSegment2TagsInner {
    pub fn new(id: i32) -> TrialBsTwoYearsResponseTrialBsTwoYearsBalancesInnerSegment2TagsInner {
        TrialBsTwoYearsResponseTrialBsTwoYearsBalancesInnerSegment2TagsInner {
            id,
            name: None,
