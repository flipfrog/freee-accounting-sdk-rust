...
pub struct TrialPlSegment1TagsResponseTrialPlSegment1Tags {
    ...
    pub balances: Vec<crate::models::TrialPlSegment1TagsResponseTrialPlSegment1TagsBalances>,
}

impl TrialPlSegment1TagsResponseTrialPlSegment1Tags {
    pub fn new(company_id: i32, segment_1_tag_ids: String, balances: Vec<crate::models::TrialPlSegment1TagsResponseTrialPlSegment1TagsBalances>) -> TrialPlSegment1TagsResponseTrialPlSegment1Tags {
