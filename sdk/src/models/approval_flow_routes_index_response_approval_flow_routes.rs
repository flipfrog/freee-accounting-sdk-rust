...
pub struct ApprovalFlowRoutesIndexResponseApprovalFlowRoutes {
    /// 申請経路ID
    #[serde(rename = "id")]
    pub id: i32,
    /// 申請経路名
...
impl ApprovalFlowRoutesIndexResponseApprovalFlowRoutes {
    pub fn new(id: i32, default_route: bool) -> ApprovalFlowRoutesIndexResponseApprovalFlowRoutes {
