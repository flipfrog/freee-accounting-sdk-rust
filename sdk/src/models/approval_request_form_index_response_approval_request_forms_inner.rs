...
pub struct ApprovalRequestFormIndexResponseApprovalRequestFormsInner {
    /// 申請フォームID
    #[serde(rename = "id")]
    pub id: i32,
    /// 事業所ID
...
impl ApprovalRequestFormIndexResponseApprovalRequestFormsInner {
    pub fn new(id: i32, company_id: i32, name: String, description: String, status: Status, created_date: String, form_order: Option<i32>, route_setting_count: i32) -> ApprovalRequestFormIndexResponseApprovalRequestFormsInner {
