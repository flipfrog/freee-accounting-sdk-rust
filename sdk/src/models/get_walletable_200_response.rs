...
pub struct GetWalletable200Response {
    #[serde(rename = "walletable")]
    pub walletable: Box<crate::models::Walletable>,
    #[serde(rename = "meta", skip_serializing_if = "Option::is_none")]
    pub meta: Option<Box<crate::models::GetWalletables200ResponseMeta>>,
}

impl GetWalletable200Response {
    pub fn new(walletable: crate::models::Walletable) -> GetWalletable200Response {
        GetWalletable200Response {
            walletable: Box::new(walletable),
            meta: None,
        }
    }
}
