...
pub struct PartnerResponsePartnerPartnerBankAccountAttributes {
    /// 受取人名（カナ）
...
impl PartnerResponsePartnerPartnerBankAccountAttributes {
    pub fn new() -> PartnerResponsePartnerPartnerBankAccountAttributes {
