...
pub struct TrialBsTwoYearsResponseTrialBsTwoYearsBalancesInnerPartnersInner {
    /// 取引先ID
    #[serde(rename = "id")]
    pub id: i32,
    /// 取引先名
...
impl TrialBsTwoYearsResponseTrialBsTwoYearsBalancesInnerPartnersInner {
    pub fn new(id: i32) -> TrialBsTwoYearsResponseTrialBsTwoYearsBalancesInnerPartnersInner {
        TrialBsTwoYearsResponseTrialBsTwoYearsBalancesInnerPartnersInner {
            id,
            name: None,
