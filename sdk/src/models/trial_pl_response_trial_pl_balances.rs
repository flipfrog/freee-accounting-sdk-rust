...
pub struct TrialPlResponseTrialPlBalances {
    /// 勘定科目カテゴリー名
    ...
    pub items: Option<Vec<crate::models::TrialBsResponseTrialBsItems>>,
    /// 期首残高
    ...
    pub partners: Option<Vec<crate::models::TrialBsResponseTrialBsPartners>>,
    ...
    pub sections: Option<Vec<crate::models::TrialPlResponseTrialPlSections>>,
    ...
    pub segment_1_tags: Option<Vec<crate::models::TrialBsResponseTrialBsSegment1Tags>>,
    ...
    pub segment_2_tags: Option<Vec<crate::models::TrialBsResponseTrialBsSegment2Tags>>,
    ...
    pub segment_3_tags: Option<Vec<crate::models::TrialBsResponseTrialBsSegment3Tags>>,
    /// 合計行(勘定科目カテゴリーの時のみ含まれる)
    #[serde(rename = "total_line", skip_serializing_if = "Option::is_none")]
    pub total_line: Option<bool>,
}

impl TrialPlResponseTrialPlBalances {
    pub fn new() -> TrialPlResponseTrialPlBalances {
