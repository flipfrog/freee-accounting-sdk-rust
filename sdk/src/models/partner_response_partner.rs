...
pub struct PartnerResponsePartner {
    ...
    pub invoice_payment_term_attributes: Option<Box<crate::models::PartnerResponsePartnerInvoicePaymentTermAttributes>>,
    /// 正式名称（255文字以内）
    ...
    pub payment_term_attributes: Option<Box<crate::models::PartnerResponsePartnerInvoicePaymentTermAttributes>>,
    /// 電話番号
...
impl PartnerResponsePartner {
    pub fn new(available: bool, code: Option<String>, company_id: i32, id: i32, name: String, update_date: String) -> PartnerResponsePartner {
