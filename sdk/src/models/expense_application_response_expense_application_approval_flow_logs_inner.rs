...
pub struct ExpenseApplicationResponseExpenseApplicationApprovalFlowLogsInner {
...
impl ExpenseApplicationResponseExpenseApplicationApprovalFlowLogsInner {
    pub fn new(action: Action, user_id: i32, updated_at: String) -> ExpenseApplicationResponseExpenseApplicationApprovalFlowLogsInner {
        ExpenseApplicationResponseExpenseApplicationApprovalFlowLogsInner {
            action,
            user_id,
            updated_at,
        }
