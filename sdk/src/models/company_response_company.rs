...
impl CompanyResponseCompany {
    pub fn new(amount_fraction: i32, contact_name: Option<String>, corporate_number: String, display_name: String, fax: Option<String>, fiscal_years: Vec<crate::models::FiscalYears>, head_count: Option<i32>, id: i32, industry_class: IndustryClass, industry_code: IndustryCode, invoice_layout: InvoiceLayout, minus_format: i32, name: Option<String>, name_kana: Option<String>, phone1: String, phone2: Option<String>, prefecture_code: Option<i32>, private_settlement: bool, role: Role, street_name1: String, street_name2: String, tax_at_source_calc_type: i32, txn_number_format: TxnNumberFormat, use_partner_code: bool, workflow_setting: WorkflowSetting, zipcode: String) -> CompanyResponseCompany {
