...
impl RenewCreateParams {
    pub fn new(company_id: i32, details: Vec<crate::models::RenewCreateParamsDetails>, renew_target_id: i64, update_date: String) -> RenewCreateParams {
        RenewCreateParams {
            company_id,
            details,
            renew_target_id,
