...
pub struct InlineResponse2008Taxes {
    /// 税区分コード
    #[serde(rename = "code")]
    pub code: i32,
    /// 税区分名
...
impl InlineResponse2008Taxes {
    pub fn new(code: i32, name: String, name_ja: String, display_category: Option<DisplayCategory>, available: bool) -> InlineResponse2008Taxes {
