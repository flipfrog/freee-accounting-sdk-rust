...
pub struct ManualJournalUpdateParamsDetailsInner {
...
impl ManualJournalUpdateParamsDetailsInner {
    /// 貸借行一覧（配列）: 貸借合わせて100行まで登録できます。
    pub fn new(entry_side: EntrySide, tax_code: i32, account_item_id: i32, amount: i64) -> ManualJournalUpdateParamsDetailsInner {
