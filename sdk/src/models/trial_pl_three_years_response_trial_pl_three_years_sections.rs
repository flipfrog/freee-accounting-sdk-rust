...
pub struct TrialPlThreeYearsResponseTrialPlThreeYearsSections {
    /// 期末残高
...
impl TrialPlThreeYearsResponseTrialPlThreeYearsSections {
    pub fn new(id: i32) -> TrialPlThreeYearsResponseTrialPlThreeYearsSections {
