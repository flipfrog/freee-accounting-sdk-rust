...
pub struct QuotationUpdateParamsQuotationContentsInner {
    /// 見積内容ID
...
impl QuotationUpdateParamsQuotationContentsInner {
    pub fn new(order: i32, r#type: RHashType) -> QuotationUpdateParamsQuotationContentsInner {
