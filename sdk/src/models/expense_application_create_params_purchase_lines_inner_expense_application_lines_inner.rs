...
pub struct ExpenseApplicationCreateParamsPurchaseLinesInnerExpenseApplicationLinesInner {
    /// 内容 (250文字以内)
...
impl ExpenseApplicationCreateParamsPurchaseLinesInnerExpenseApplicationLinesInner {
    pub fn new() -> ExpenseApplicationCreateParamsPurchaseLinesInnerExpenseApplicationLinesInner {
        ExpenseApplicationCreateParamsPurchaseLinesInnerExpenseApplicationLinesInner {
            description: None,
            amount: None,
