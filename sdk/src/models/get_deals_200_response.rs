...
pub struct GetDeals200Response {
    #[serde(rename = "deals")]
    pub deals: Vec<crate::models::Deal>,
    #[serde(rename = "meta")]
    pub meta: Box<crate::models::GetDeals200ResponseMeta>,
}

impl GetDeals200Response {
    pub fn new(deals: Vec<crate::models::Deal>, meta: crate::models::GetDeals200ResponseMeta) -> GetDeals200Response {
        GetDeals200Response {
            deals,
            meta: Box::new(meta),
        }
